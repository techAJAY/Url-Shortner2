...
// connect to redis 
const redisClient = redis.createClient(11383,
    "redis-11383.c212.ap-south-1-1.ec2.cloud.redislabs.com",
    { no_ready_check: true }
);
redisClient.auth("NAIP2pdS7e8nG1Qp2w1lLSOb2oGxcGkC", function (err) {
    if (err) throw err;
});
